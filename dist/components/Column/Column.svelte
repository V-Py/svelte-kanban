<script>import { onMount, getContext, createEventDispatcher } from "svelte";
import { columns } from "../../stores/store";
import { fly, scale } from "svelte/transition";
import Card from "../Card.svelte";
import OptionsColumn from "./OptionsColumn.svelte";
import { globalLang } from "../../stores/store";
...
function handleMouseDown(e, index_card) {
